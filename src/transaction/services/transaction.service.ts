...
import { PAYMENT_METHOD, STATUS, TransactionEntity } from "../entity/transaction.entity";
...
export class TransactionService{
    ...
    async prepareTransaction(payload:transactionDto):Promise<TransactionInterface>{
    ...
    async prepareOrderRecord(payload){
        ...
        order.order_total = (payload.product_quantities * payload.product.price).toString();
    }
